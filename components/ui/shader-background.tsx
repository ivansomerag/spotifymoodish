...
// ShaderBackground — WebGL plasma background, recolored to match Moodish's
// dark navy / teal-cyan palette (#080C14, #14F195, #22d3ee).
...
// Moodish retro pop palette: navy base → deep teal → neon green → cyan → synth purple → neon magenta
const NAVY: [number, number, number] = [0.02, 0.035, 0.07] // #050912
const DEEP_TEAL: [number, number, number] = [0.02, 0.14, 0.12] // #05241F
const NEON_TEAL: [number, number, number] = [0.08, 0.96, 0.60] // #14F599
const CYAN: [number, number, number] = [0.0, 0.92, 1.0] // #00EBFF
const SYNTH_PURPLE: [number, number, number] = [0.68, 0.22, 0.98] // #AD38FA
const NEON_MAGENTA: [number, number, number] = [1.0, 0.15, 0.58] // #FF2694

const UNIFORMS = {
  colors: [NAVY, DEEP_TEAL, NEON_TEAL, CYAN, SYNTH_PURPLE, NEON_MAGENTA, NAVY, NAVY] as [number, number, number][],
  colorCount: 6,
  scale: 1.3,
  intensity: 0.82,
  paramA: 0.5,
